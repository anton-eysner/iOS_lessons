...
- Создаете отдельную ветку для задачи
- Затем когда задание выполнено пушим ветку и создаем пулл реквест. В пулл реквесте выставляем слияние в главную ветку
